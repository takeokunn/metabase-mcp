...
describe('exportDashcardQuery tool', () => {
  it('should return formatted MCP response with export data', async () => {
    ...
    const result = await exportDashcardQueryDefinition.handler(mockClient, {
      dashboard_id: 1,
      dashcard_id: 2,
      card_id: 3,
      export_format: 'csv',
  ...
  it('should propagate client errors', async () => {
    ...
    await expect(
      exportDashcardQueryDefinition.handler(mockClient, {
        dashboard_id: 999,
        dashcard_id: 1,
        card_id: 1,
        export_format: 'json',
  ...
  it('should have correct tool definition metadata', () => {
    ...
    expect(exportDashcardQueryDefinition.description).toBe(
