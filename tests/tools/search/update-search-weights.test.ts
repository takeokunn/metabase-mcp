...
describe('updateSearchWeights tool', () => {
  it('should return formatted MCP response', async () => {
    ...
    expect(mockClient.put).toHaveBeenCalledWith('/api/search/weights', {
      card: 2.0,
      dashboard: 1.5,
    });
  ...
  it('should propagate client errors', async () => {
    ...
    await expect(
      updateSearchWeightsDefinition.handler(mockClient, { weights: {} }),
  ...
  it('should have correct tool definition metadata', () => {
    ...
    expect(updateSearchWeightsDefinition.description).toBe(
