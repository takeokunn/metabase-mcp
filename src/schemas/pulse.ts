...
export const CreatePulseInputSchema = z.object({
  ...
  cards: z.array(z.record(z.string(), z.unknown())).describe('Cards to include in the pulse'),
  channels: z.array(z.record(z.string(), z.unknown())).describe('Channels to send the pulse to'),
...
export const UpdatePulseInputSchema = z.object({
  ...
  cards: z.array(z.record(z.string(), z.unknown())).optional().describe('Cards to include'),
  channels: z.array(z.record(z.string(), z.unknown())).optional().describe('Channels to send to'),
  skip_if_empty: z.boolean().optional().describe('Skip sending if result is empty'),
...
export const TestPulseInputSchema = z.object({
  pulse: z.record(z.string(), z.unknown()).describe('Pulse object to test'),
});
