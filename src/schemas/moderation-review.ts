...
export const CreateModerationReviewInputSchema = z.object({
  ...
  moderated_item_type: z
    .string()
    .describe('Type of the item being reviewed (e.g., "card", "dashboard")'),
  status: z
    .string()
    .nullable()
    .describe('Moderation status to set (e.g., "verified", "blocked", or null to remove)'),
