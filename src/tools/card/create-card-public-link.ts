...
import {
  type CreateCardPublicLinkInput,
  CreateCardPublicLinkInputSchema,
...
export const createCardPublicLinkDefinition: ToolDefinition<CreateCardPublicLinkInput> = {
  ...
  description: 'Create a public sharing link for a card (saved question) in Metabase (returns UUID)',
